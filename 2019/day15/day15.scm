...
;  after a rupture in oxygen tank two; that section of the ship was automatically
...
;  already know will get a reply of 1 because you already know that location
;  is open):
;
;       
;    ## 
...
;     # 
;       
; Then, perhaps west (3) gets a reply of 0, south (2) gets a reply of 1, south again
;  (2) gets a reply of 0, and then west (3) gets a reply of 2:
;
;       
;    ## 
;   #..#
...
;  from its starting position to the location of the oxygen system? (Answer: 246)
;
...
;  will it take to fill with oxygen? (Answer: 376)
;

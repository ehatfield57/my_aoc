defmodule Intcode do
  ...
  defp extract_modes(modes, count) do
    ...
    modes_digits = modes_digits ++ List.duplicate(0, count - length(modes_digits))
...
defmodule ScaffoldRobot do
  def main do
    ...
    intcode = %Intcode{memory: program, pointer: 0, relative_base: 0, inputs: [], outputs: [], halted: false}

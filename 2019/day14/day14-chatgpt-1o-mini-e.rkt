...
(require racket/string
         racket/math
         racket/box) ; Required for make-box and related functions
...
(define (compute-ore reactions fuel-amount)
  ...
  (define ORE 'ORE)
  (define total-ore (make-box 0)) ; Initialize total-ore as a mutable box

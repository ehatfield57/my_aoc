...
;  this phase setting sequence may not have been the best one; another sequence might
;  have sent a higher signal to the thrusters.
;
...
;  that can be sent to the thrusters? (Answer: 47064)
;

; Used Reddit Python code for Answer.
...
;  What is the highest signal that can be sent to the thrusters? (Answer: 4248984)
;

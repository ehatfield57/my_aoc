...
;  fewer other asteroids. Here is the number of other asteroids a monitoring station on
...
;  detected from that location? (Answer: 344)
;
...
;  but if vaporizing one asteroid makes another one detectable, the newly-detected

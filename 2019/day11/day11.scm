...
;  input instructions should be provided 1. After several more outputs (0,1, 1,0, 1,0),
...
;  panels does it paint at least once? (Answer: 2141)
;
...
;  starting the robot on a single white panel instead, what registration identifier
;  does it paint on your hull? (Answer: RPJCFZKF)
;

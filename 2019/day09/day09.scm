...
;  it runs on passes some checks to demonstrate it is a complete Intcode
;  computer.
;
...
;  opcodes (and the associated parameter modes) that seem to be functioning incorrectly,
...
;  the BOOST keycode. What BOOST keycode does it produce? (Answer: ?)
;

; Used Reddit Python Answer
...
;  In sensor boost mode, the program will output a single value: the coordinates
;  of the distress signal.
;
; Run the BOOST program in sensor boost mode. What are the coordinates
;  of the distress signal? (Answer: 49115)
;
